...
CHART_DEFS = [
    ...
    ("Daily Revenue (KPI)", "echarts_timeseries_bar", "kpi_daily_overview",
     {"metrics": [_m("total_revenue")], "granularity_sqla": "pickup_date",
    ...
    ("Borough Market Share", "pie", "kpi_borough_comparison",
     {"metrics": [_m("total_revenue")], "groupby": ["borough"],
      "time_range": "No filter"}),
    ...
    ("Vendor Market Share", "pie", "kpi_vendor_performance",
     {"metrics": [_m("trip_count")], "groupby": ["vendor_id"],
      "time_range": "No filter"}),
    ...
    ("Invalid by Reason", "pie", "dq_invalid_by_reason",
